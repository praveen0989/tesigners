define([], function(){
	...
	this.render = function(container){
		...
		var signupDiv = '<div id="usernamediv" class="form-group">'+ this.userName + '</div>';
		
		this. phoneNumber = '<input type="text" id = "phoneNumberinput" class="form-control" name="phoneNumber" value="" placeholder="Phone Number"/>';
		...
		var passwordDiv = '<div id="passworddiv" class="form-group"> '+ this.password +'</div>';
